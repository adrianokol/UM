...
<div class="clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if} block-shopping_cart">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span class="ajax_cart_product_txt_s{if $cart_qties < 2 && $cart_qties != 0} unvisible{/if}">{l s='Products' mod='blockcart'}</span>
...
{*				{/if} *}
			...
			<span class="cart_link">{l s='View my shopping cart' mod='blockcart'}&nbsp;&nbsp;&#9658;</span>
{*
			<b id="ajax_cart_cart" {if $cart_qties == 0} class="cart_empty"{/if}>{l s='Cart' mod='blockcart'}</b>
										...
										<div class="cart-info">
											<div class="product-name">
												<span class="quantity-formated">
                                                	<span class="quantity">{$product.cart_quantity}</span>&nbsp;st&nbsp;
                                                </span>
		...
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="layer_cart_row totalex">
					<strong class="dark">
						{l s='Total (tax excl.)' mod='blockcart'}
					</strong>
