...
{else}
	<div id="carrier_area" class="opc-main-block">
		<h1 class="page-heading step-num"><span>3</span> {l s='Delivery methods'}</h1>
	...
	{else}
		...
		{else}
				...
				{if isset($delivery_option_list)}
					{foreach $delivery_option_list as $id_address => $option_list}
						...
						{*
							...
							{/if}
						*}
							{l s='Choose a shipping option that suits you'}
						</p>
			...
			{if $conditions AND $cms_id}
				<p class="carrier_title hidden">{l s='Terms of service'}</p>
