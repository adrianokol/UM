...
*}	
    <form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
        	<div>
			<h1 class="page-heading step-num"><span>1</span> {l s='Identity'}</h1>
{*
...
*}
					...
					*}
					...
					<div class="text form-group">
						<label for="company">{l s='Company'}</label>
						<input type="text" class="text form-control validate" data-validate="isName" name="company" id="company" value="{if isset($guestInformations) && isset($guestInformations.company) && isset($guestInformations) && isset($guestInformations.company) && $guestInformations.company}{$guestInformations.company}{/if}" />
					</div>
...
*}
                    <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
                        <label for="phone_mobile">{l s='Phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
					...
					<div class="form-group is_customer_param">
                        ...
                        <textarea class="form-control" name="other" id="other" cols="26" rows="4"></textarea>
                    </div>
                    <input type="hidden" name="alias" id="alias" value="{l s='My address'}"/>
    
					<hr class="splitter">
	
					<h1 class="page-heading step-num invoice"><span>2</span> {l s='Invoice address'}</h1>
...
*}
                        {foreach from=$inv_all_fields item=field_name}
							...
							*}
							...
							<div class="text form-group">
								<label for="company_invoice">{l s='Company'}</label>
								<input type="text" class="text form-control" name="company_invoice" id="company_invoice" value="{if isset($guestInformations) && isset($guestInformations.company_invoice) && isset($guestInformations) && isset($guestInformations.company_invoice) && $guestInformations.company_invoice}{$guestInformations.company_invoice}{/if}" />
							</div>
                            {elseif $field_name eq "address1"}
                            <div class="required form-group">
...
*}
                        <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
                            <label for="phone_mobile_invoice">{l s='Phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
                            <input type="text" class="text form-control" name="phone_mobile_invoice" id="phone_mobile_invoice" data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone_mobile_invoice) && $guestInformations.phone_mobile_invoice}{$guestInformations.phone_mobile_invoice}{/if}" />
                        </div>
						<div class="form-group is_customer_param">
...
{strip}
    ...
    {if isset($countries)}
		...
		{addJsDef mycountries=$countries}
    {/if}
