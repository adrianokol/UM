...
{assign var="freeShippingThreshold" value="495.0"}
...
*}
        ...
        <!-- center infos -->
	<div class="product_rightpart">
		<div class="pb-center-column col-xs-12 {if $columns == 2} col-sm-12 col-md-6{elseif $columns == 3} col-sm-12{else} col-sm-7{/if}">
...
*}
        ...
        <!-- pb-right-column-->
		<div class="pb-right-column col-xs-12 {if $columns == 2} col-sm-12 col-md-12 two-colums{elseif $columns == 3} col-md-12 three-colums{else} col-sm-4 col-md-5{/if}">
...
{*
										{if $tax_enabled  && ((isset($display_tax_label) && $display_tax_label == 1) || !isset($display_tax_label))}
											<span style="font-size: 50%;">{if $priceDisplay == 1}{l s='tax excl.'}{else}{l s='tax incl.'}{/if}</span>
										{/if}
*}
...
*}
					...
					<div class="product_attributes product-sellingpoints">
						<ul>
							<li><i class="icon-ok"></i>{l s='Free delivery'}</li>
							<li><i class="icon-ok"></i>{l s='Good purchase'}</li>
							<li><i class="icon-ok"></i>{l s='Quick delivery'}</li>
						</ul>
					</div>
...
*}
	...
	{if !$content_only}
		...
		<div class="specifications_and_reviews">
			{if isset($features) && $features}
				<!-- Data sheet -->
				<section class="page-product-box specs">
		...
		{if $product->description}
			<!-- More info -->
			<section class="page-product-box">
				<h3 class="page-product-heading">{l s='More info on'} {$product->name|escape:'html':'UTF-8'}</h3>{/if}
				{if isset($product) && $product->description}
					<!-- full description -->
					<div  class="rte">{if isset($moredesc)}{$moredesc}{else}{$product->description}{/if}</div>
			</section>
			<!--end  More info -->
		{/if}
        ...
        {if isset($accessories) && $accessories}
			<!--Accessories -->
			<section class="page-product-box other_products">
									...
									<li class="item product-box ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
										...
										<div class="clearfix" style="margin-top:5px">
											{if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0)}
												<div class="no-print">
													<a class="exclusive btn btn-default button ajax_add_to_cart_button" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='Add to cart'}">
														<span>{l s='Add to cart'}</span>
													</a>
												</div>
											{/if}
